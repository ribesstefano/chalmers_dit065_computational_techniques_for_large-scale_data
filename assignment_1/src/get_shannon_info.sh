#!/bin/bash
#SBATCH --partition=cpu-shannon
#SBATCH --cpus-per-task=1
#SBATCH --output=/bayes_datainbackup/home/2022/ribes/chalmers_dit065_computational_techniques_for_large-scale_data/assignment_1/src/serverinfo_shannon.out
#SBATCH --error=/bayes_datainbackup/home/2022/ribes/chalmers_dit065_computational_techniques_for_large-scale_data/assignment_1/src/serverinfo_shannon.error
